  ...
  return (
    <div className="min-h-screen flex items-center justify-center">
      <div className="w-full max-w-md bg-white p-8 rounded-lg shadow-xl transform transition-all duration-00 hover:scale-105">
        ...
        <p className="text-gray-600 text-center mt-2 mb-6">Welcome back! Please sign in to continue.</p>

        {message && <p className="text-red-500 text-center mb-4">{message}</p>}

        <form method="post" className="space-y-6" onSubmit={handleSubmit}>
          <div>
            <label className="block text-gray-700 font-medium text-left" htmlFor="username">
              Username
            </label>
            <input
              type="text"
          ...
          <div className="relative">
            <label className="block text-gray-700 font-medium text-left" htmlFor="password">
              Password
            </label>
            <input
              type="password"
            ...
            />
            <a href="#" className="text-indigo-600 text-sm absolute right-3 top-9 hover:underline transition duration-300">
              Forgot Password?
            </a>
          </div>
